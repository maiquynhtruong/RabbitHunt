...
public class Model {
    ...
    static Vector<Integer> looks = new Vector<Integer>();
    ...
    void populate () {
       ...
       for (int i = 0; i < numberOfBushes; i++) {
           ...
           /** if location is empty, put a bush there */
           if (field[bushRow][bushColumn] == null) {
               field[bushRow][bushColumn] = bush;
           }
           else 
              i--;  /** if location occupied, try again */
       }
